...
- **Changed:** Reworded `docs/spec.md` from the PlumbBob intent.md framing (Frame, D1/C1 labels, and Steps with seams and "done when") into a conventional RFC/proposal layout with Summary, Motivation, Goals, Non-goals, Design, Constraints, and Implementation plan sections. The technical content is unchanged.
